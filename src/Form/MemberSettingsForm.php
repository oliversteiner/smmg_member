...
namespace Drupal\smmg_member\Form;
...
class MemberSettingsForm extends ConfigFormBase
{
    ...
    {
        return 'smmg_member_settings_form';
    }
    ...
    {
        // Load Settings
        $config = $this->config('smmg_member.settings');

        // load all Template Names
        $template_list = MemberController::getTemplateNames();
        ...
        $form['email']['email_from'] = array(
            '#type' => 'textfield',
            '#title' => $this->t('Email: From (member@example.com)'),
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        $this->configFactory->getEditable('smmg_member.settings')
            //
            //
            // Fieldset General
            // -------------------------------------------------------------
        ...
        //  Twig Templates
        // -------------------------------------------------------------
        $config = $this->configFactory->getEditable('smmg_member.settings');
