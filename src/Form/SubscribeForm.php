...
class SubscribeForm extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        // JS and CSS
        $form['#attached']['library'][] = 'smmg_member/smmg_member.main';
        ...
        // ===============================================
        $form['subscribe'] = [
            '#title' => $this->t('I want to receive the member.'),
            '#type' => 'checkbox',
            '#default_value' => 1,
        ];
        ...
        if ($subscribe === 1) {
            ...
            if ($email == '') {
                ...
                $form_state->setErrorByName('email',
                    $this->t('An email address is required to receive the member.'));
    ...
    function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        if ($values['subscribe'] == 1) {
            ...
            $result = MemberController::newSubscriber($values);
            ...
            if ($result && $result['status']) {
                ...
                $form_state->setRedirect('smmg_member.thank_you', $arg);
